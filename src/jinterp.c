...
/*  { "music",		do_music,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
    ...
    { ".",		do_ooc,		POS_SLEEPING,	 0,  LOG_NORMAL, 1 },
...
/*  { "practice",	do_practice,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
     ...
     * Level 102
     */
    { "castall",	do_castall,	POS_DEAD,	IM,  LOG_ALWAYS, 1 },
    { "clone",		do_clone,	POS_DEAD,	IM,  LOG_ALWAYS, 1 },
    { "giveall",	do_giveall,	POS_DEAD,	IM,  LOG_ALWAYS, 1 },
    ...
    { "aedit",		do_aedit,	POS_DEAD,    	IM,  LOG_ALWAYS, 1 },
