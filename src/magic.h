...
DECLARE_SPELL_FUN(	spell_acid_darts	);
DECLARE_SPELL_FUN(	spell_aid		);
DECLARE_SPELL_FUN(	spell_acid_rain		);
DECLARE_SPELL_FUN(	spell_advanced_mind	);
DECLARE_SPELL_FUN(	spell_armor		);
DECLARE_SPELL_FUN(	spell_aquastrike	);
...
DECLARE_SPELL_FUN(	spell_enhanced_mind	);
DECLARE_SPELL_FUN(	spell_ethreal_blade	);
...
DECLARE_SPELL_FUN(	spell_flamepillar	);
DECLARE_SPELL_FUN(	spell_flaming_eyes	);
...
DECLARE_SPELL_FUN(	spell_iron_shards	);
DECLARE_SPELL_FUN(	spell_know_alignment	);
DECLARE_SPELL_FUN(	spell_lightning_bolt	);
DECLARE_SPELL_FUN(	spell_lightningshield	);
DECLARE_SPELL_FUN(	spell_locate_object	);
DECLARE_SPELL_FUN(	spell_magic_missile	);
DECLARE_SPELL_FUN(	spell_mana_charge	);
DECLARE_SPELL_FUN(      spell_mass_healing	);
DECLARE_SPELL_FUN(	spell_mass_invis	);
DECLARE_SPELL_FUN(	spell_mini_meteor	);
...
DECLARE_SPELL_FUN(	spell_silver_shards	);
