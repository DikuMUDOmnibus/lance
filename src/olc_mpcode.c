...
void do_mpedit(CHAR_DATA *ch, char *argument)
{
	...
	if ( ad == NULL )
	{
		send_to_char( "MPEdit : Vnum has no area.\n\r", ch );
		return;
	}
...
MPEDIT (mpedit_create)
{
    ...
    if ( ad == NULL )
    {
    	send_to_char( "MPEdit : VNUM isn't assigned to an area.\n\r", ch );
    	return FALSE;
    }
...
MPEDIT( mpedit_list )
{
    ...
    {
    	if ( fAll )
    		add_buf( buffer, "MobPrograms don't exist.\n\r" );
    	else
    		add_buf( buffer, "No MobPrograms in this area.\n\r" );
    }
