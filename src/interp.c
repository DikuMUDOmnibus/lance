...
/*  { "wield",		do_wear,	POS_RESTING,	 0,  LOG_NORMAL, 1 }, */
    { "right",		do_right,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "left",		do_left,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "drag",           do_drag,        POS_STANDING,    0,  LOG_NORMAL, 1 },
    { "push",           do_push,        POS_STANDING,    0,  LOG_NORMAL, 1 },
    { "block",		do_block,	POS_STANDING,	 0,  LOG_NORMAL, 1 }, 
     ...
     */
    { "acredits",	do_acredits,	POS_DEAD,	 0,  LOG_NORMAL, 1 },
    { "affects",	do_affects,	POS_DEAD,	 0,  LOG_NORMAL, 1 },
    { "areas",		do_areas,	POS_DEAD,	 0,  LOG_NORMAL, 1 },
    { "arealink",       do_arealinks,   POS_DEAD,       L7,  LOG_NORMAL, 1 },
    ...
    { "finger",		do_finger,	POS_SLEEPING,	 0,  LOG_ALWAYS, 1 },
...
/*    { "map"			do_map,	POS_RESTING,	 0,	LOG_NORMAL, 1 },*/
    ...
    { "war",            do_war,         POS_DEAD,        0,  LOG_NORMAL, 1 },
    ...
    { "bwho",		do_bwho,	POS_DEAD,	 0,  LOG_NORMAL, 1 },
    { "ahours",		do_ahours,	POS_DEAD,	 0,  LOG_NORMAL, 1 },
    ...
    { "allauto",        do_allauto,     POS_DEAD,        0,  LOG_NORMAL, 1 },
...
/*  { "channels",	do_channels,	POS_DEAD,	 0,  LOG_NORMAL, 1 }, */
    ...
    { "clanwho",	do_whoclan,	POS_DEAD,	 0,  LOG_NORMAL, 1 },
...
/*  { "iaw",		do_iaw,		POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
/*  { "auction",	do_auction,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
    ...
    { "icaction",	do_icaction,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 },
    { "ic2",            do_ic2,         POS_SLEEPING,    0,  LOG_NORMAL, 1 },
    { "icaction2",	do_icaction2,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 },
    { "ica2",		do_icaction2,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 },
    { "lsay",		do_lsay,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
/*  { "music",		do_music,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
...
/*  { "shout",		do_shout,	POS_RESTING,	 2,  LOG_NORMAL, 1 }, */
    { "smote",		do_smote,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    ...
    { "rp",		do_rp,		POS_RESTING,	 0,  LOG_NEVER,  1 },
    /*
...
/*  { "unlock",		do_unlock,	POS_RESTING,	 0,  LOG_NORMAL, 1 }, */
    ...
    { "surge",		do_surge,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "layhands",	do_layhands,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    ...
    { "blackjack",	do_blackjack,	POS_STANDING,	 0,  LOG_NORMAL, 0 },
    ...
    { "sap",		do_sap,	POS_STANDING,	 0,  LOG_NORMAL, 0 },
    { "swordthrust",	do_thrust,	POS_FIGHTING,	 0,  LOG_NORMAL, 0 },
    { "lunge",		do_lunge,	POS_FIGHTING,	 0,  LOG_NORMAL, 0 },
    { "finesse",	do_finesse,	POS_FIGHTING,	 0,  LOG_NORMAL, 0 },
    { "surrender",	do_surrender,	POS_FIGHTING,    0,  LOG_NORMAL, 1 },
    { "trip",		do_trip,	POS_FIGHTING,    0,  LOG_NORMAL, 1 },
    { "blur",		do_blur,	POS_STANDING,	 0,	 LOG_ALWAYS, 1 },
...
/*  { "bank",		do_bank,	POS_STANDING,	 0,  LOG_NORMAL, 1 }, */
    { "brew",		do_brew,	POS_STANDING,	 0,  LOG_ALWAYS, 1 },
    { "craps",		do_craps,	POS_STANDING,	 0,  LOG_NORMAL, 1 },
    { "safe",		do_safe,	POS_STANDING,	 0,  LOG_NORMAL, 1 },
...
/*  { "practice",	do_practice,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
    ...
    { "remor",		do_remor,	POS_STANDING,	 0,  LOG_NORMAL, 0 },
    ...
    { "track",		do_hunt,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "visible",	do_visible,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 },
/*  { "wake",		do_wake,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
    { "school",		do_school,	POS_STANDING,	 0,  LOG_NORMAL, 1 },
    { "scribe",		do_scribe,	POS_STANDING,	 0,  LOG_ALWAYS, 1 },
    { "bounty",		do_bounty,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "skin",		do_skin,	POS_STANDING,    0,  LOG_ALWAYS, 1 },
     ...
     * Level 102
     */
    { "namewizi",       do_wiziname,       POS_DEAD,       IM,  LOG_NORMAL, 1 },
    { "staff",          do_staff,       POS_DEAD,       IM,  LOG_NORMAL, 1 },
    { "goto",           do_goto,        POS_DEAD,       IM,  LOG_NORMAL, 1 },
    { "holylight",	do_holylight,	POS_DEAD,	IM,  LOG_NORMAL, 1 },
    { "iaw",		do_iaw,		POS_DEAD,	IM,  LOG_NORMAL, 1 },
    ...
    { "mlevel",         do_mlevel,      POS_DEAD,       IM,  LOG_NORMAL, 1 },
    { "mudstatus",	do_mudstatus,	POS_DEAD,	IM,  LOG_NORMAL, 1 },
    { "mwhere",		do_mwhere,	POS_DEAD,	IM,  LOG_NORMAL, 1 },
    { "olevel",         do_olevel,      POS_DEAD,       IM,  LOG_NORMAL, 1 },
    { "owhere",		do_owhere,	POS_DEAD,	IM,  	LOG_NORMAL, 1 },
    { "pk",			do_pk,	POS_DEAD,   IM,  	LOG_NORMAL, 1 },
...
/*  { "smote",		do_smote,	POS_DEAD,	IM,  LOG_NORMAL, 1 }, */
    ...
    { "switch",         do_switch,      POS_DEAD,       IM,  LOG_NORMAL, 1 },
    ...
    { "unlink",         do_unlink,      POS_DEAD,       L6,  LOG_NORMAL, 1 },
    { "echo",		do_recho,	POS_DEAD,	L6,  LOG_ALWAYS, 1 },
    { "omni",		do_omni,	POS_DEAD,	L6,  LOG_NORMAL, 1 },
    { "peace",		do_peace,	POS_DEAD,	L6,  LOG_NORMAL, 1 },
    { "plist",		do_plist,	POS_DEAD,	L6,  LOG_NORMAL, 1 },
    { "wpeace",         do_wpeace,      POS_DEAD,       L6,  LOG_NORMAL, 1 },
...
/*  { "return",         do_return,      POS_DEAD,       L6,  LOG_NORMAL, 1 }, */
    ...
    { "otype",		do_otype,	POS_DEAD,	L5,  LOG_ALWAYS, 1 },
    { "flag",		do_flag,	POS_DEAD,	L5,  LOG_ALWAYS, 1 },
    { "freeze",		do_freeze,	POS_DEAD,	L5,  LOG_ALWAYS, 1 },
    { "home",		do_home,	POS_DEAD,	L5,  LOG_ALWAYS, 1 },
    { "roomwizi",	do_roomwiz,	POS_DEAD,	L5,  LOG_NORMAL, 1 },
    { "teleport",	do_transfer,    POS_DEAD,	L5,  LOG_ALWAYS, 1 },	
    { "transfer",	do_transfer,	POS_DEAD,	IM,  LOG_ALWAYS, 1 },
    { "transin",	do_transin,	POS_DEAD,	IM,  LOG_NORMAL, 1 },
    { "transout",	do_transout,	POS_DEAD,	IM,  LOG_NORMAL, 1 },
    ...
    { "castall",        do_castall,     POS_DEAD,       L4,  LOG_NORMAL, 0 },
    { "clone",          do_clone,       POS_DEAD,       L4,  LOG_ALWAYS, 1 },
    { "deny",           do_deny,        POS_DEAD,       L4,  LOG_ALWAYS, 1 },
    { "giveall",        do_giveall,     POS_DEAD,       L4,  LOG_ALWAYS, 1 },
    { "gecho",		do_echo,	POS_DEAD,	L5,  LOG_ALWAYS, 1 },
    { "guild",		do_guild,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
    { "load",		do_load,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
    { "multi",		do_multi,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
    { "nochannels",	do_nochannels,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
    { "noemote",	do_noemote,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
    { "noexp",          do_noexp,       POS_DEAD,       L4,  LOG_ALWAYS, 1 },
    { "nonote",		do_nonote,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
    { "noshout",	do_noshout,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
    { "notell",		do_notell,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
    { "notitle",        do_notitle,     POS_DEAD,       L4,  LOG_ALWAYS, 1 },
    ...
    { "clearquest",	do_clearquest,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
    { "sedit",          do_sedit,       POS_DEAD,       L4,  LOG_NORMAL, 1 },

    /*
     * Level 107
     */

    { "bonus",          do_bonus,       POS_DEAD,       L3,  LOG_ALWAYS, 1 },
    ...
    { "slip",		do_slip,	POS_DEAD,	L3,  LOG_ALWAYS, 1 },
    { "snoop",		do_snoop,	POS_DEAD,	L3,  LOG_ALWAYS, 1 },
    { "rlink",          do_rlink,       POS_DEAD,       L3,  LOG_ALWAYS, 1 },
    { "arset",		do_arset,	POS_DEAD,	L3,  LOG_ALWAYS, 1 },

    /*
     * Level 108
     */

    { "grab",		do_grab,	POS_DEAD,	L2,  LOG_ALWAYS, 1 },
    { "badname",	do_illegalname,	POS_DEAD,	L2,  LOG_ALWAYS, 1 },
    { "set",		do_set,		POS_DEAD,	L2,  LOG_ALWAYS, 1 },
    { "log",		do_log,		POS_DEAD,	L2,  LOG_ALWAYS, 1 },
    { "memory",		do_memory,	POS_DEAD,	L2,  LOG_NORMAL, 1 },
    { "aedit",          do_aedit,       POS_DEAD,       L2,  LOG_NORMAL, 1 },
    /*
     * Level 109
     */

    { "permban",        do_permban,     POS_DEAD,       L1,  LOG_ALWAYS, 1 },
    { "copyove",	do_copyove,	POS_DEAD,	L1,  LOG_NEVER,	 0 },
    { "copyover",       do_copyover,    POS_DEAD,       L1,  LOG_ALWAYS, 1 }, 
    { "dump",		do_dump,	POS_DEAD,	L1,  LOG_ALWAYS, 0 },
    { "skillset",	do_skillset,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
    { "showskills",	do_showskills,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
    { "showspells",	do_showspells,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
    { "nuke",           do_nuke,        POS_DEAD,       L1,  LOG_ALWAYS, 1 },
    ...
    { "addlag",         do_addlag,      POS_DEAD,       ML,  LOG_ALWAYS, 1 },
    ...
    { "undelete",	do_undelete,	POS_DEAD,	ML,  LOG_ALWAYS, 1 },

    /*
     * OLC
     */
    { "edit",		do_olc,		POS_DEAD,    	IM,  LOG_ALWAYS, 1 },
    { "asave",          do_asave,	POS_DEAD,    	IM,  LOG_ALWAYS, 1 },
    { "alist",		do_alist,	POS_DEAD,    	IM,  LOG_ALWAYS, 1 },
    { "resets",		do_resets,	POS_DEAD,    	IM,  LOG_ALWAYS, 1 },
    { "redit",		do_redit,	POS_DEAD,    	IM,  LOG_ALWAYS, 1 },
    { "medit",		do_medit,	POS_DEAD,    	IM,  LOG_ALWAYS, 1 },
    { "oedit",		do_oedit,	POS_DEAD,    	IM,  LOG_ALWAYS, 1 },
    { "mpedit",		do_mpedit,	POS_DEAD,    	IM,  LOG_ALWAYS, 1 },
    { "hedit",		do_hedit,	POS_DEAD,    	IM,  LOG_ALWAYS, 1 },
    { "mlist",		do_mlist,	POS_DEAD,	IM,  LOG_ALWAYS, 1 },
    { "rlist",		do_rlist,	POS_DEAD,	IM,  LOG_ALWAYS, 1 },
    { "olist",		do_olist,	POS_DEAD,	IM,  LOG_ALWAYS, 1 },

    /*
     * Clan commands
     */
    { "petition",	do_petition,	POS_SLEEPING,	15,  LOG_NORMAL, 1 },
    { "clancmd",	do_clancmd,	POS_RESTING,	15,  LOG_NORMAL, 1 },

    /*
     * Placed here to prevent command conflicts
     */
...
/*	    if(IS_NPC(ch) && ch->desc == NULL)
	    	allgrant = ch->desc->original->grant;
	    else
*/	    	allgrant = ch->grant;
	    while( allgrant != NULL )
	    {
    ...
    && cmd_table[cmd].disabled)
    {
    	send_to_char("That command has been temporarily disabled.\n\r", ch);
    	return;
    }
	...
	case POS_MORTAL:
	case POS_INCAP:
	    send_to_char( "{DYou are hurt far too bad for that{x.\n\r", ch );
	    break;

	case POS_STUNNED:
	    send_to_char( "{DYou are too stunned to do that.\n\r{x", ch );
	    break;
...
bool check_social( CHAR_DATA *ch, char *command, char *argument )
{
    ...
    case POS_STUNNED:
	send_to_char( "{DYou are too stunned to do that{x.\n\r", ch );
	return TRUE;
...
void do_wizhelp( CHAR_DATA *ch, char *argument )
{
	...
	case ML:
	   ...
	   {
	      send_to_char("\n\r{R-{r-{GLevel 110{r-{R-{x\n\r",ch);
	   }
	   break;
	case L1:
	   if(ch->level >= MAX_LEVEL-1)
	   {
	      send_to_char("\n\r{R-{r-{GLevel 109{r-{R-{x\n\r",ch);
	   }
	   break;
	case L2:
	   if(ch->level >= MAX_LEVEL-2)
	   {
	      send_to_char("\n\r{R-{r-{GLevel 108{r-{R-{x\n\r",ch);
	   }
	   break;
	case L3:
	   if(ch->level >= MAX_LEVEL-3)
	   {
	      send_to_char("\n\r{R-{r-{GLevel 107{r-{R-{x\n\r",ch);
	   }
	   break;
	case L4:
	   if(ch->level >= MAX_LEVEL-4)
	   {
	      send_to_char("\n\r{R-{r-{GLevel 106{r-{R-{x\n\r",ch);
	   }
	   break;
	case L5:
	   if(ch->level >= MAX_LEVEL-5)
	   {
	      send_to_char("\n\r{R-{r-{GLevel 105{r-{R-{x\n\r",ch);
	   }
	   break;
	case L6:
	   if(ch->level >= MAX_LEVEL-6)
	   {
	      send_to_char("\n\r{R-{r-{GLevel 104{r-{R-{x\n\r",ch);
	   }
	   break;
	case L7:
	   if(ch->level >= MAX_LEVEL-7)
	   {
	      send_to_char("\n\r{R-{r-{GLevel 103{r-{R-{x\n\r",ch);
	   }
	   break;
	case L8:
	   if(ch->level >= MAX_LEVEL-8)
	   {
	      send_to_char("\n\r{R-{r-{GLevel 102{r-{R-{x\n\r",ch);
	   }
	   break;
	}
    col = 0;
	...
	{
	        sprintf( buf, "{c[{y%d{c] %-12s{x", cmd_table[cmd].level, cmd_table[cmd].name );
