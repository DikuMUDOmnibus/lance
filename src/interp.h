...
#define L1	MAX_LEVEL - 1  	/* coder */
#define L2	MAX_LEVEL - 2	/* supreme being */
#define L3	MAX_LEVEL - 3	/* demigod */
#define L4 	MAX_LEVEL - 4	/* god */
#define L5	MAX_LEVEL - 5	/* builder */
#define L6	MAX_LEVEL - 6	/* social */
#define L7	MAX_LEVEL - 7	/* avatar */
#define L8	MAX_LEVEL - 8	/* immortal */
...
DECLARE_DO_FUN(	do_bwho		);
DECLARE_DO_FUN(	do_ahours	);
...
DECLARE_DO_FUN( do_castall	);
DECLARE_DO_FUN( do_giveall	);
DECLARE_DO_FUN( do_petition	);
DECLARE_DO_FUN( do_clancmd	);
...
DECLARE_DO_FUN( do_icaction	);
DECLARE_DO_FUN( do_icaction2	);
