...
bool spec_nasty( CHAR_DATA *ch )
{
    ...
    {
        case 0:  act( "$n rips apart your coin purse, spilling your steel!",
                     ch, NULL, victim, TO_VICT);
                 act( "You slash apart $N's coin purse and gather his steel.",
...
bool spec_cast_cleric( CHAR_DATA *ch )
{
	...
	case  8: min_level = 14; spell = "aquastrike";	   break;
	case  9:
...
bool spec_qmaster( CHAR_DATA *ch )
{
