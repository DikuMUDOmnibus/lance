...
#define PULSE_ROUND		  ( 5 * PULSE_PER_SECOND)

#define IMPLEMENTOR		MAX_LEVEL
#define	CODER			(MAX_LEVEL - 1)
#define SUPREME			(MAX_LEVEL - 2)
#define DEMIGOD			(MAX_LEVEL - 3)
#define GOD			(MAX_LEVEL - 4)
#define BUILDER                 (MAX_LEVEL - 5)
#define SOCIAL			(MAX_LEVEL - 6)
#define AVATAR			(MAX_LEVEL - 7)
#define IMMORTAL		(MAX_LEVEL - 8)
...
#define CON_GET_HAND			19
#define CON_SHOW_GODS			20
#define CON_GET_HAND2			21
#define CON_GET_PK			22
#define CON_GET_HAIR			23
#define CON_GET_WEIGHT			24
#define CON_GET_HEIGHT			25
#define CON_GET_EYE			26
...
/*
 ...
 struct god_type
 {
     ...
     bool       pc_human;              	/* can be chosen by Human pcs */
     bool       pc_silv;               	/* can be chosen by Silvanesti pcs */
     bool       pc_qual;             	/* can be chosen by Qualinesti pcs */
     bool       pc_kag;              	/* can be chosen by Kagonesti pcs */
     bool	pc_dim;			/* can be chosen by Dimernesti pcs */
     bool	pc_darg;		/* can be chosen by Dargonesti pcs */
     bool	pc_helf;		/* can be chosen by Half-Elf pcs */
     bool	pc_hylar;		/* can be chosen by Hylar pcs */
     bool	pc_neidar;		/* neidar */
     bool	pc_aghar;		/* aghar */
     bool	pc_gnome;		/* gnome */
     bool	pc_kender;		/* kender */
     bool	pc_mino;		/* minotaur */
     sh_int	recall;			/* recall vnum */
 };
 

/* Defined for restricting class selection by certain races
 * JN 06/11/02
 */
...
struct	class_type
{
    ...
    char *	desc;			/* Description of Class		*/
    char *	base_group;		/* base skills gained		*/
    char *	default_group;		/* default skills gained	*/
    long	race_restrict;		/* bit for unusable class	*/
    long	previous_class;		/* old class allowed to use?	*/
    long	bit;			/* restricts class choices	*/
    int		remort; 		/* # of remorts req'd to choose */
};

/* Restricts classes - JN */
#define NO_MAGE 	(A)
#define NO_CLERIC	(B)
#define NO_THIEF	(C)
#define NO_WARRIOR	(D)
...
struct pc_race_type  /* additional data for pc races */
{
    ...
    char *	desc;			/* Short description used in creation*/
    char *	skills[5];		/* bonus skills for the race */
    sh_int 	stats_min[MAX_STATS];	/* Minimum starting stats */
    sh_int	stats_max[MAX_STATS];	/* Maximum starting stats */
	sh_int	max_stats[MAX_STATS];	/* maximum stats */
    sh_int	size;			/* aff bits for the race */
    sh_int	age;			/* starting age */
    long	bit;			/* used for setting restrictions */
};
 ...
 * Defined in #MOBILES.
 */
#define MOB_VNUM_FIDO		  15999
#define MOB_VNUM_ZOMBIE		3

#define MOB_VNUM_GOLEM		      1
#define MOB_VNUM_FAMILIAR             2
...
#define ACT_BANKER		(A)
#define ACT_GAMBLER		(B)
#define ACT_NO_ATTACK		(C)
#define ACT_NO_COUNTER		(D)
...
#define AFF_SLOW		(dd)
#define AFF_TRUE_SIGHT		(ee)
#define AFF_BLACKJACK		(G)

/* Aff2 */

#define AFF_ENHANCED_MIND	(A)
#define AFF_ADVANCED_MIND	(B)
#define AFF_FLAMESHIELD		(C)
#define AFF_SILENCE		(D)
#define AFF_HALLUCINATING	(E)
#define AFF_BLUR		(F)
#define AFF_LIGHTNING		(G)
#define AFF_LAYHANDS		(H)
#define AFF_FLAME_EYE		(I)
/* Immortal-only flags */
#define IMMF_ROOMWIZ		(A)
...
#define OBJ_VNUM_SBLOOD		      7
#define OBJ_VNUM_LBLOOD		      8
...
#define OBJ_VNUM_SAFE_TOKEN	     19

#define OBJ_VNUM_MUSHROOM	     20
#define OBJ_VNUM_LIGHT_BALL	     21
#define OBJ_VNUM_SPRING		     22
#define OBJ_VNUM_DISC		     23
#define OBJ_VNUM_SAFE_CONT	     24
#define OBJ_VNUM_PORTAL	             25
#define OBJ_VNUM_EBLADE			301
#define OBJ_VNUM_HOLYBLADE		303

#define OBJ_VNUM_ROSE		      6
#define OBJ_VNUM_SKIN		      46
#define OBJ_VNUM_PIT		   14724

#define OBJ_VNUM_SCHOOL_MACE	   16018
#define OBJ_VNUM_SCHOOL_DAGGER	   16019
#define OBJ_VNUM_SCHOOL_SWORD	   16020
#define OBJ_VNUM_SCHOOL_SPEAR	   16033
#define OBJ_VNUM_SCHOOL_STAFF	   16034
#define OBJ_VNUM_SCHOOL_AXE	   16035
#define OBJ_VNUM_SCHOOL_FLAIL	   16036
#define OBJ_VNUM_SCHOOL_WHIP	   16037
#define OBJ_VNUM_SCHOOL_POLEARM    16038
#define OBJ_VNUM_SCHOOL_LANCE	   16039

#define OBJ_VNUM_SCHOOL_VEST	   16021
#define OBJ_VNUM_SCHOOL_SHIELD	   16022
#define OBJ_VNUM_SCHOOL_BANNER     16032
...
#define ITEM_PARCHMENT		     35
#define ITEM_PEN		     36
#define ITEM_SHOP_ALL		     37
#define ITEM_SPELL		     38
 ...
 * Used in #OBJECTS.
 */
#define ITEM_MAGE_ONLY		(A)
#define ITEM_CLERIC_ONLY	(B)
#define ITEM_THIEF_ONLY		(C)
#define ITEM_WARRIOR_ONLY	(D)
#define ITEM_PALADIN_ONLY	(E)
#define ITEM_RANGER_ONLY	(F)
#define ITEM_TEMPLAR_ONLY	(G)
#define ITEM_BMAGE_ONLY		(H)
/*#define ITEM_ALL		(ITEM_MAGE_ONLY | ITEM_CLERIC_ONLY | ITEM_THIEF_ONLY | ITEM_WARRIOR_ONLY | ITEM_PALADIN_ONLY | ITEM_RANGER_ONLY | ITEM_TEMPLAR_ONLY	| ITEM_BMAGE_ONLY)
*/
...
#define ROOM_VNUM_TEMPLE	  11500
/*#define ROOM_VNUM_ALTAR		   3054*/
#define ROOM_VNUM_SCHOOL	  16000
#define ROOM_VNUM_BALANCE	   4500
#define ROOM_VNUM_CIRCLE	   4400
#define ROOM_VNUM_DEMISE	   4201
#define ROOM_VNUM_HONOR		   4300
#define ROOM_VNUM_NEUTRAL_TEMPLE  17001
#define ROOM_VNUM_GOOD_TEMPLE	  11500
#define ROOM_VNUM_EVIL_TEMPLE	  11400
#define ROOM_HAL_1					28650
#define ROOM_HAL_2					28670
#define ROOM_HAL_3					28690
#define ROOM_HAL_4					28710
#define ROOM_HAL_5					28730
...
#define ROOM_NO_RECALL		(N) /* Changed to prevent conflicts with existing rooms */
#define ROOM_NO_TRANS		(U)
#define ROOM_NO_SUMMON		(V)
#define ROOM_NO_GATE		(W)
#define ROOM_NO_SCRYE		(X)
#define ROOM_NOMAGIC		(Y)
...
#define WEAR_RIGHT		     16 /* Previously wear_wield */
#define WEAR_LEFT		     17 /* Previously wear_hold */
#define WEAR_FLOAT		     18
#define WEAR_ANKLE		     19
#define WEAR_EAR		     20
#define WEAR_BACK                    21
#define WEAR_TATTOO_L                22
#define WEAR_TATTOO_R                23
#define WEAR_FACE                    24
#define MAX_WEAR		     25
...
#define PLR_CLANWHO		(L)

/* JN Mounted flag*/
#define PLR_MOUNTED		(K)
...
#define PLR_DENY			(W)
#define PLR_FREEZE		(X)
#define PLR_VIOLENT		(Y)
#define PLR_THIEF			(Z)
#define PLR_KILLER		(aa)
#define PLR_NOTITLE           (bb)
#define PLR_NOEXP             (cc)
#define PLR_SLAIN			(dd)
#define PLR_ROLEPL		(ee)
#define PLR_CONSENT		(K)
#define PLR_ROLEP2		(B)
#define PLR_NOQP		(S)
...
#define COMM_NOOSAY		(J)
#define COMM_NOBEEP		(K)
#define COMM_NOIC             (aa)
#define COMM_NOOOC            (bb)
#define COMM_IAW			(cc)
...
extern	sh_int	gsn_silvanesti;
extern	sh_int	gsn_qualinesti;
extern	sh_int	gsn_dimernesti;
extern	sh_int	gsn_dargonesti;
extern	sh_int	gsn_kagonesti;
extern	sh_int	gsn_hylar;
extern	sh_int	gsn_neidar;
extern	sh_int	gsn_aghar;
extern	sh_int	gsn_gnome;
...
extern	sh_int	gsn_right_hand;
extern	sh_int	gsn_left_hand;
...
#define DEFAULT_WIZINAME        "{RThe Gods{x"
...
#define get_carry_weight(ch)	((ch)->carry_weight + (ch)->gold/10 +  \
						      (ch)->steel * 2 / 5)
...
#if	defined(sequent)
char *	crypt		args( ( const char *key, const char *salt ) );
char *  file_exists     args( ( FILE *stream ) );
...
#if defined(unix)
#define LAST_CMD_FILE	"../lastcmd.txt"	/* The last command before crash*/
#define PLAYER_DIR      "../player/"        	/* Player files */
#define PLAYER_BAK	"../player/bak/"	/* Saved deleters */
...
#define WAR_FILE        "war.not"
#define STAFF_FILE      "staff.not"
#define SHUTDOWN_FILE   "shutdown.txt"/* For 'shutdown'*/
#define BAN_FILE	"ban.txt"
#define MUSIC_FILE	"music.txt"
#define DISABLE_FILE	"disabled.txt"

#define OBJ_BUG_FILE	"checkobj.txt"
...
bool	make_blood	args( ( CHAR_DATA *ch, int chance, bool show ) );
...
void    get_obj         args( ( CHAR_DATA *ch, OBJ_DATA *obj,
                            OBJ_DATA *container ) );
int	count_box	args( (CHAR_DATA *ch) );
...
char *	center		args( ( char *str, int len ) );

 /*
  * Colour stuff by Lope
  */
 int   colour          args( ( char type, CHAR_DATA *ch, char *string ) );
 int   d_colour          args( ( char type, char *string ) );
...
/* handler.c */
void	pet_follow	args( (CHAR_DATA *ch, CHAR_DATA *pet) );
...
int	get_weapon_sn	args( ( CHAR_DATA *ch, int hand ) );
...
char *	immf_bit_name	args( ( int immf_flags ) );
...
char *	clanrank_name	args( ( CHAR_DATA *ch ) );
/*
 * Colour Config
 */
